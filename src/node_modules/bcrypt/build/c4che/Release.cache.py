...
CPPPATH_OPENSSL = ['/usr/include', '/usr/includes', '/usr/local/includes', '/opt/local/includes', '/usr/sfw/lib']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
HAVE_OPENSSL_RAND_H = 1
LIBDIR = '/home/rafael/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_OPENSSL = ['/lib', '/usr/lib', '/usr/local/lib', '/opt/local/lib', '/usr/sfw/lib']
LIBPATH_ST = '-L%s'
LIB_OPENSSL = ['ssl']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/rafael/.node_libraries'
PREFIX = '/usr/local'
